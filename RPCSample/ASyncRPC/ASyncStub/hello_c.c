...
/* [async] */ void  HelloProc( 
    /* [in] */ PRPC_ASYNC_STATE HelloProc_AsyncHandle,
    /* [string][in] */ wchar_t *pszString)
{
    ...
    NdrAsyncClientCall(
                      ...
                      ( unsigned char * )&HelloProc_AsyncHandle);
...
void Shutdown( void)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&hello_StubDesc,
                  (PFORMAT_STRING) &hello__MIDL_ProcFormatString.Format[72],
                  ( unsigned char * )0);
...
/* 10 */	NdrFcShort( 0x0 ),	/* 0 */
/* 12 */	NdrFcShort( 0x8 ),	/* 8 */
/* 14 */	0xc6,		/* Oi2 Flags:  clt must size, has return, has ext, has async handle */
			0x2,		/* 2 */
/* 16 */	0x8,		/* 8 */
